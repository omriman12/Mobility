...
public class ExecutionRequestWrapper {
    ////private Logger logger = //logger.getLogger(RoutingRequestWrapper.class.getName());
    private il.co.telzar.schemas.npexecution.Request _request;
    
    public ExecutionRequestWrapper (il.co.telzar.schemas.npexecution.Request req) {
        _request = req;
    }
    
    public ExecutionRequestWrapper () {
        _request = new il.co.telzar.schemas.npexecution.Request();
    }
...
*/
    ...
    public il.co.telzar.schemas.npexecution.DnChoice getDnChoice(){
       return _request.getDnChoice();
    }
    
    public il.co.telzar.schemas.npexecution.Request getRequest(){
        return _request;
    }
    
    public void setRequest(il.co.telzar.schemas.npexecution.Request req){
        _request = req;
    }
    ...
    public String getMessageId(){
        return _request.getMessageId();
    }
            
    public String getRequestType(){
        return _request.getRequestType();
    } 
    
    public String getCrmCustomerId(){
        return _request.getCrmCustomerId();
    } 
    
    public String getCrmRequestId(){
        return _request.getCrmRequestId();
    } 
    
    public String getDnType(){
        return _request.getDnType();
    } 
    ...
    public String getCrmSeqId(){
        return _request.getCrmSeqId();
    } 
    
    public void setLocalDNNumber(String dn_num){
        il.co.telzar.schemas.npexecution.DnChoice dnchoise = new il.co.telzar.schemas.npexecution.DnChoice();
        dnchoise.setDnNumber(dn_num);
        _request.setDnChoice(dnchoise);
    }
    
    public String getLocalDNNumber(){
        return  _request.getDnChoice().getDnNumber();
    }
