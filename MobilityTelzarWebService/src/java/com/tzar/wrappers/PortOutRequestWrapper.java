...
public class PortOutRequestWrapper {
    ////private Logger logger = //logger.getLogger(RoutingRequestWrapper.class.getName());
    private il.co.telzar.schemas.npportoutcheck.Request _request;
    
    public PortOutRequestWrapper (il.co.telzar.schemas.npportoutcheck.Request req) {
        _request = req;
    }
    
    public PortOutRequestWrapper () {
        _request = new il.co.telzar.schemas.npportoutcheck.Request();
    }
...
*/
    ...
    public il.co.telzar.schemas.npportoutcheck.Request getRequest(){
        return _request;
    }
    
    public void setRequest(il.co.telzar.schemas.npportoutcheck.Request req){
        _request = req;
    }
